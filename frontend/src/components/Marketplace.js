...
const MarketplaceView = ({ products: initialProducts = [], isStorePage = false, showMobileChat = false, onCloseMobileChat = () => {}, }) => { 
...
if(activeImageIndices){
  ...
  }, [isStorePage, initialProducts.length]);
          ...
          <div className="border-t">
            ...
            >
              ...
              <span className="bg-green-100 text-green-800 px-2 py-1 rounded-full transition-all duration-300 hover:bg-green-200">
                ...
                {/* Mobile Chat Panel */}
                <MobileChatPanel isOpen={showMobileChat} onClose={onCloseMobileChat}>
            <div className="h-full flex flex-col">
              {/* Reuse all the existing chat content */}
              <div className="p-4 bg-green-50 border-b">
                <div className="flex items-center gap-2">
                  <PackageSearch size={24} className="text-green-600" />
                  <div>
