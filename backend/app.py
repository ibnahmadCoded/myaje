...
app.include_router(admin.router, prefix="/admin", tags=["admin_management"])
app.include_router(restock.router, prefix="/restock", tags=["restock"])
app.include_router(router=admin_restock.router, prefix="/admin/restock", tags=["admin_restock"])
