...
class QueryIntentParser:
    def __init__(self, confidence_threshold: float = 0.1):
        ...
        self.intent_patterns = {
            ...
            'find_products': [
                'find me a shoe under $50',
                'get me shoes less than 50 dollars',
                'show products under 100',
                'find items within 200 dollars',
                'search for products below 150',
                'find products more than 50 dollars',
                'get items above 100',
                'show me products higher than 75',
                'find products between 50 and 100',
                'search items from 20 to 50 dollars',
                'get products around 50 dollars',
                'find items approximately 100 dollars', 
                'get me shirt costing less than 3000'
            ],
            'filter_products': [
            ...
            'add_to_cart': [
                ...
                'put this product in my cart',
                'add the second product to basket',
                'add to cart',
                'buy this now',
                'purchase this item',
                'add two of these to cart',
